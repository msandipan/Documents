...
class ResNet(nn.Module):
    def __init__(self, block, layers, block_inplanes,used_layers,
                 conv1_t_size=7,conv1_t_stride=1,
                 n_input_channels=1,n_classes=3):
...
if __name__ == '__main__':
    net = resnet50(used_layers = [3,4])
    print(net)
    #net = net.cuda()
    var = torch.FloatTensor(1, 1, 127, 127, 127)
    # var = Variable(var)
